...
<div class="form">
	<form:form action="${ctx}/product/update" method="POST" modelAttribute="product" >
		...
		<div style="width:40%; float:left; margin-right:30px;">
			...
			<dl>
                <dt>Premium <form:checkbox path="premium" cssClass="" /></dt>
			...
			<dl>
				<dt>Publisher Inactive <form:checkbox path="publisherInactive" cssClass="" /></dt>
			...
			<dl>
				<dt>Supports Ads?</dt>
				<dd><form:checkbox path="supportsAds" />
				<form:errors path="supportsAds" cssClass="error" element="label" /></dd>
			</dl>
			...
			<dl>
				...
				<dd><form:textarea path="relatedProducts" />
				<form:errors path="relatedProducts" cssClass="error" element="label" /></dd>
			</dl>
...
<script type="text/javascript">
	...
	function resetPageExtents() {
		$('#oneUpPageExtent').val('0');
		$('#twoUpPageExtent').val('0');
		$('#a5PageExtent').val('0');
		return true;
	}
