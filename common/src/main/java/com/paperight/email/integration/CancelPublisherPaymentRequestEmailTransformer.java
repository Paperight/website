...
public class CancelPublisherPaymentRequestEmailTransformer extends EmailTransformer {
    ...
    protected String getTemplateName() {
    	return "email-template-cancel-publisher-payment-request";
    }

	@Override
	protected String getDefaultTemplateContent() throws IOException {
		Resource resource = new ClassPathResource("/velocity/cancelPublisherPaymentRequestEmail.vm");
		return IOUtils.toString(resource.getInputStream());
	}
	
	@Override
	protected String getInternalSubject() {
		return "Cancel Publisher Payment Request";
	}
