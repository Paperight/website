...
public class UserRegistrationEmailTransformer extends EmailTransformer {
	
	private static final String toEmail = "team@paperight.com";
    ...
    protected String getTemplateName() {
    	return "email-template-user-registration";
    }

	@Override
	protected String getDefaultTemplateContent() throws IOException {
		Resource resource = new ClassPathResource("/velocity/userRegistrationEmail.vm");
...
//		return "/velocity/userRegistrationEmail.vm";
//	}
